...
export default auth(async (req: any) => {
    ...
    const cspHeader = [
        ...
        `connect-src 'self' https://*.supabase.co wss://*.supabase.co https://*.pages.dev https://*.apinator.io wss://*.apinator.io https://accounts.google.com https://api.telegram.org https://ipapi.co https://api.dicebear.com https://lh3.googleusercontent.com https://images.unsplash.com https://catbox.moe https://*.catbox.moe https://files.catbox.moe https://*.soundhelix.com https://www.soundhelix.com https://itunes.apple.com https://*.mzstatic.com${backendUrl ? ' ' + backendUrl : ''}`,
        "frame-src 'self' https://accounts.google.com",
        "media-src 'self' blob: https://*.supabase.co https://catbox.moe https://*.catbox.moe https://files.catbox.moe https://*.soundhelix.com https://*.mzstatic.com",
        "object-src 'none'",
        "base-uri 'self'",
        "form-action 'self'",
